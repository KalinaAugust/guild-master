  ...
  it('maps participants and resolves viewer flags', async () => {
    const from = vi.fn()
      .mockReturnValueOnce(query({ data: [
        { id: 'p1', event_id: 'e1', user_id: 'u2', status: 'confirmed', profiles: { full_name: 'Bob', avatar_url: 'a.png' } },
      ] }))
    ...
    expect(result.participants).toEqual([
      { id: 'p1', event_id: 'e1', user_id: 'u2', status: 'confirmed', profile: { fullName: 'Bob', avatarUrl: 'a.png' } },
    ]);
  });
