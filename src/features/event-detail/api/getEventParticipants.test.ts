  ...
  it('maps participants and resolves viewer flags', async () => {
    const from = vi.fn()
      .mockReturnValueOnce(query({ data: [
        { id: 'p1', event_id: 'e1', user_id: 'u2', status: 'confirmed', profiles: { public_id: 'pub2', full_name: 'Bob', avatar_url: 'a.png', alias: null, display_as_alias: false, icon: null, about: 'Tank main' } },
      ] }))
    ...
    expect(result.participants).toEqual([
      { id: 'p1', event_id: 'e1', user_id: 'u2', status: 'confirmed', profile: { publicId: 'pub2', fullName: 'Bob', avatarUrl: 'a.png', alias: null, displayAsAlias: false, icon: null, about: 'Tank main' } },
    ]);
  });
