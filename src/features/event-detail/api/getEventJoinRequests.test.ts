...
describe('getEventJoinRequests', () => {
  it('maps pending requests with profile data', async () => {
    const from = vi.fn().mockReturnValue(query({ data: [
      { id: 'r1', user_id: 'u2', created_at: 't1', profiles: { public_id: 'pub2', full_name: 'Bob', avatar_url: 'a.png', alias: null, display_as_alias: false } },
      { id: 'r2', user_id: 'u3', created_at: 't2', profiles: { public_id: 'pub3', full_name: 'Carol', avatar_url: null, alias: 'Caz', display_as_alias: true } },
    ...
    await expect(getEventJoinRequests('e1')).resolves.toEqual([
      ...
      { id: 'r2', userId: 'u3', publicId: 'pub3', userName: 'Caz', avatarUrl: null, createdAt: 't2' },
      { id: 'r3', userId: 'u4', publicId: null, userName: null, avatarUrl: null, createdAt: 't3' },
    ]);
  });
