...
const baseRow = (overrides: Partial<PollRow> = {}): PollRow => ({
  ...
  poll_votes: [
    { option_id: 'o1', user_id: 'u1', created_at: '2026-06-01T10:00:00Z', profiles: { public_id: 'pub1', full_name: 'One', avatar_url: null, alias: null, display_as_alias: false, icon: null } },
    { option_id: 'o1', user_id: 'u2', created_at: '2026-06-01T10:01:00Z', profiles: { public_id: 'pub2', full_name: 'Two', avatar_url: null, alias: null, display_as_alias: false, icon: null } },
    { option_id: 'o2', user_id: 'u1', created_at: '2026-06-01T10:02:00Z', profiles: { public_id: 'pub1', full_name: 'One', avatar_url: null, alias: null, display_as_alias: false, icon: null } },
  ],
  ...overrides,
});
