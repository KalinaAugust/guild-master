...
/**
 * Lightweight unread check for the sidebar dot: true when at least one call to
 * action from another user is newer than the viewer's last-read timestamp.
 */
export const getCallToActionsUnread = async (
  guildId: string,
